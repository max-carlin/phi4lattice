...
def MD_traj(state, key_pair, params: HMCParams, measure_fns = None):
    ...
    mom_refreshed = randomize_core(mom_keys, params.lat_shape, mu=0, sigma=1)
    ...
    if params.metropolis:
        ...
        S_prime,_,_ = action_core(phi_fx, params.lam, params.kappa,
                                        params.D, params.shift, params.spatial_axes)
        H_prime = mom_term_prime + S_prime

        mom_term_old = hamiltonian_kinetic_core(mom_refreshed, params.spatial_axes)
        S_old,_,_ = action_core(phi_old, params.lam, params.kappa,
                                        params.D, params.shift, params.spatial_axes)
